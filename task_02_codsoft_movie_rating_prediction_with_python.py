# -*- coding: utf-8 -*-
"""Task_02_CodSoft_Movie_Rating_Prediction_With_Python.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xT6L3WPRcBVCfk4Q_aDOSXY6BjEP2OwO
...
import pandas as pd
df = pd.read_csv('/content/B. Priyanka IMDb Movies India.csv', encoding='latin1')
df.head()
...
import seaborn as sns
import matplotlib.pyplot as plt  # You may also want to import matplotlib for visualization

# Assuming 'df' is your DataFrame
sns.heatmap(df.isnull(), cmap='viridis')  # 'viridis' is a colormap, you can choose a different one if you prefer
...
import numpy as np  # You also need to import numpy if it's not already imported

# Assuming you have defined y_test and y_pred_LR previously
...
# Assuming you have defined X and y previously
